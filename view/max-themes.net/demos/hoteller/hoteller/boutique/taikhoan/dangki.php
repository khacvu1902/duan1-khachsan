    ...
    <div class="ct" style="border-radius:20px;;height:50%;width:180%;margin-left:-43%;margin-top:15%; ">
        ...
        <form action="../index.php?act=dangki" method="post">
            <div class="form1" style="text-align:center;">
                ...
                <div>
                    <label for=""  class="text-lg" style="color: #fff;margin-left:-38%;">Password</label><br>
                ...
                <div>
                    <label for="" class="text-lg" style="color: #fff;margin-left:-38%;">Số điện thoại</label><br>
                    <input type="text" name="phone" class="bg-inherit text-black" style="padding: 8px 0;width:50%;border-radius:10px;border:1px solid #FFCACA;" required>
                </div>
                <div>
                    <label for="" class="text-lg" style="color: #fff;margin-left:-38%;">Địa chỉ</label><br>
                    <input type="text" name="add" class="bg-inherit text-black" style="padding: 8px 0;width:50%;border-radius:10px;border:1px solid #FFCACA;" required>
                </div>
            ...
            <div class="form3" style="text-align:center;margin-bottom:15px;">
                <input type="submit" value="Đăng kí" name="dangki" class=" mx-2 hover:bg-gradient-to-r from-violet-500 to-fuchsia-500 hover:scale-105" style="border: 1px solid #fff;border-radius: 10px;color: #fff;padding: 8px 35px; cursor: pointer;">
