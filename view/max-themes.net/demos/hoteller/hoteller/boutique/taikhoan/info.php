...
<body class="bg-gradient-to-r from-green-700  to-green-500 h-screen flex justify-center items-center text-white">
    <div class="bg-neutral-900 w-96 mb-16 mx-auto lg:h-4/5 h-full lg:rounded-lg text-center overflow-hidden p-5">
   
        <div class="w-36 h-36 border-solid border-4 border-rose-600 rounded-full overflow-hidden m-auto  ">
            <img src="../upload/101048866-768x576.jpg" alt="">
        </div>
        ...
        <div class="flex-wrap mt-5">
            <button class="w-36 h-10 border-solid border bg-transparent text-white rounded-xl hover:bg-rose-500 transition delay-150 duration-300 ease-in-out border-rose-600 m-2">
